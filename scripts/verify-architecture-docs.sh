...
for tool in repoverification semanticeventactivity eventauthority providerdraftmapping terminalresultmapping shutdownauthority approvaltimeout processlifecycle; do
