...
| Class | Count |
| --- | ---: |
| Generated reader docs | 206 |
| Direct SSOT docs | 1 |
| Registered manual docs | 90 |
| Scanned docs | 297 |
...
| --- | --- | --- | ---: |
| `domain-ontology-manual-surface` | daemon/domain | promote docs/20-domain into generated ontology and invariant registries | 23 |
