...
| Class | Count |
| --- | ---: |
| Generated reader docs | 151 |
| Direct SSOT docs | 1 |
| Registered manual docs | 145 |
| Scanned docs | 297 |
...
| --- | --- | --- | ---: |
| `domain-ontology-manual-surface` | daemon/domain | promote docs/20-domain into generated ontology and invariant registries | 78 |
...
| --- | ---: |
| `docs/20-domain/provider-runtime` | 28 |
