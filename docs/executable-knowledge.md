...
| --- | ---: | --- |
| `docs` | 337 | `docs/20-domain/context-map/acl-locations.riido.json`<br>`docs/20-domain/context-map/change-procedure.riido.json`<br>`docs/20-domain/context-map/dependency-direction.riido.json` |
...
- Complete manifest loops: `344`
- Direct manifest loops: `21`
- Delegated manifest loops: `323`
