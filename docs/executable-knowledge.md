...
| --- | ---: | --- |
| `docs` | 339 | `docs/20-domain/context-map/acl-locations.riido.json`<br>`docs/20-domain/context-map/change-procedure.riido.json`<br>`docs/20-domain/context-map/dependency-direction.riido.json` |
...
- Complete manifest loops: `346`
- Direct manifest loops: `21`
- Delegated manifest loops: `325`
