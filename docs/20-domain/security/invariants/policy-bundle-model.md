...
Policy bundle is the single decision source for this domain. Every gate receives the active policy bundle and returns allow, reject, or hold.
...
- Moving an in-flight task to a new bundle follows T-POLICY in [`runtime-upgrade-flow.md`](../../../30-architecture/runtime-upgrade-flow.md).
