...
- Files: `tools/localqacandidatedecision/annotation.go`, `tools/localqacandidatedecision/annotation_escape.go`, `tools/localqacandidatedecision/candidate.go`, `tools/localqacandidatedecision/candidate_more.go`, `tools/localqacandidatedecision/candidate_problem.go`, `tools/localqacandidatedecision/candidate_problem_more.go`, `tools/localqacandidatedecision/decision.go`, `tools/localqacandidatedecision/decision_counts.go`, `tools/localqacandidatedecision/main.go`, `tools/localqacandidatedecision/options.go`, `tools/localqacandidatedecision/render.go`, `tools/localqacandidatedecision/run.go`, `tools/localqacandidatedecision/types_candidate.go`, `tools/localqacandidatedecision/verify.go`, `tools/localqacandidatedecision/workflow.go`, `tools/localqacandidatedecision/annotation_test.go`, `tools/localqacandidatedecision/candidate_test.go`, `tools/localqacandidatedecision/decision_test.go`, `tools/localqacandidatedecision/product_loop_decision_test.go`, `tools/localqacandidatedecision/run_test.go`, `.github/workflows/local-qa-runner.yml`, `.github/workflows/product-loop-evidence.yml`
...
- Evidence: `local-qa-candidate-decision`, `decision_artifacts`, `matched_decision_count`, `scope_decision_count`, `allowed_missing_decision_count`, `required_next_artifacts`, `evidence_graph`, `product-loop-candidate-decision`
- Verifiers: `candidate-decision-annotation-test`, `candidate-decision-cover-test`, `candidate-decision-artifact-test`, `candidate-decision-product-loop-test`, `candidate-decision-input-test`
...
- Files: `tools/productloopevidence/candidates.go`, `tools/productloopevidence/candidates_test.go`, `tools/productloopevidence/candidate_graph.go`, `tools/productloopevidence/constants.go`, `tools/productloopevidence/fixture_test.go`, `tools/productloopevidence/format.go`, `tools/productloopevidence/files.go`, `tools/productloopevidence/io.go`, `tools/productloopevidence/main.go`, `tools/productloopevidence/manifest.go`, `tools/productloopevidence/meta.go`, `tools/productloopevidence/ops_readiness_test.go`, `tools/productloopevidence/ops_scenarios_test.go`, `tools/productloopevidence/partial.go`, `tools/productloopevidence/partial_age.go`, `tools/productloopevidence/partial_candidate.go`, `tools/productloopevidence/partial_local_qa.go`, `tools/productloopevidence/partial_registry.go`, `tools/productloopevidence/partial_test.go`, `tools/productloopevidence/partial_types.go`, `tools/productloopevidence/path.go`, `tools/productloopevidence/product.go`, `tools/productloopevidence/render.go`, `tools/productloopevidence/report.go`, `tools/productloopevidence/report_test.go`, `tools/productloopevidence/report_types.go`, `tools/productloopevidence/route_coverage.go`, `tools/productloopevidence/route_map.go`, `tools/productloopevidence/route_render.go`, `tools/productloopevidence/route_types.go`, `tools/productloopevidence/run.go`, `tools/productloopevidence/schedule.go`, `tools/productloopevidence/schedule_candidate.go`, `tools/productloopevidence/schedule_render.go`, `tools/productloopevidence/schedule_source.go`, `tools/productloopevidence/schedule_test.go`, `tools/productloopevidence/schedule_types.go`, `tools/productloopevidence/source_types.go`, `tools/productloopevidence/types.go`, `.github/workflows/local-qa-runner.yml`, `.github/workflows/product-loop-evidence.yml`
- Docs: `docs/30-architecture/entrypoint-route-map.riido.json`, `docs/30-architecture/entrypoint-route-map.md`, `docs/30-architecture/local-acceptance-coverage.riido.json`, `docs/30-architecture/product-loop-evidence.riido.json`, `docs/30-architecture/product-loop-evidence.md`, `docs/30-architecture/local-qa-daily-trigger.dsl.json`, `docs/30-architecture/loop-registry.riido.json`, `docs/30-architecture/loop-registry.md`
- Evidence: `product-loop-evidence`, `meta_complexity`, `route_coverage`, `qa_schedule`, `local_qa_run_evidence_state`, `local_qa_run_evidence_fresh`, `product_acceptance`, `partial_reduction`, `closed_loop_candidates`, `client_surface_anomaly_monitoring`, `stress_capacity`, `scale_chaos`, `release_readiness`
- Verifiers: `product-loop-acceptance-test`, `product-loop-mapping-test`, `product-loop-route-coverage-test`, `product-loop-candidate-test`, `product-loop-open-candidate-debt-test`, `product-loop-qa-schedule-test`, `product-loop-local-qa-freshness-test`, `product-loop-operational-readiness-test`, `product-loop-claim-binding-test`
...
Daemon lifecycle, status, shutdown, tool-approval IPC, local API, and default local paths must match the host: Unix sockets and Application Support roots on Darwin/Linux, and local-only named pipes plus LocalAppData workdirs on Windows. Windows clients must retry the pre-Accept file-not-found startup window, named-pipe closure conditions must surface as EOF after a complete response, and a native Windows daemon status round trip must pass, so desktop health checks and direct CLI recovery cannot create a daemon restart loop, reject a valid response, or select an unsupported transport.

- Files: `cmd/riido/api_connection_config.go`, `cmd/riido/api_connection_config_test.go`, `cmd/riido/claude_permission_mcp_decision.go`, `cmd/riido/daemon_child_ready.go`, `cmd/riido/daemon_config_workdir_default.go`, `cmd/riido/daemon_host_paths.go`, `cmd/riido/daemon_host_paths_test.go`, `cmd/riido/daemon_ipc_call.go`, `cmd/riido/daemon_ipc_default_paths.go`, `cmd/riido/daemon_ipc_transport.go`, `cmd/riido/daemon_ipc_transport_test.go`, `cmd/riido/daemon_ipc_windows_integration_test.go`, `cmd/riido/daemon_shutdown_socket.go`, `cmd/riido/daemon_socket_server.go`, `cmd/riido/serve_command.go`, `internal/riidoapi/local_transport_endpoint.go`, `internal/riidoapi/local_transport_windows.go`, `internal/riidoapi/local_transport_windows_conn.go`, `internal/riidoapi/local_transport_windows_dial.go`, `internal/riidoapi/local_transport_windows_native.go`, `.github/workflows/riidoapi.yml`
- Docs: `docs/30-architecture/loop-registry.riido.json`, `docs/30-architecture/loop-registry.md`
- Evidence: `production.windows_daemon.restart_loop_47_pids_29m`, `windows_amd64.daemon_cross_compile`, `windows_native.named_pipe.daemon_status_round_trip`, `daemon_local_ipc_transport_regression`, `local_api_host_defaults_regression`
- Verifiers: `daemon-host-transport-selection-test`, `daemon-host-default-path-selection-test`, `local-api-host-default-selection-test`, `windows-named-pipe-remote-client-gate`, `windows-native-daemon-status-round-trip-test`, `windows-native-daemon-status-round-trip-workflow`
