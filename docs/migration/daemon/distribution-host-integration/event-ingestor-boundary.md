...
`github.com/teamswyg/riido-contracts/ir`, and imports the local public C7 policy
redaction catalog from `internal/policy`.
...
workdir sink port, task DB/project/mwsd local API packages, packaging artifacts,
