...
func validateHeader(m Manifest) []problem {
	var problems []problem
	if m.SchemaVersion != "riido-policy-bundle-loader-evidence.v1" {
		problems = append(problems, problem{"schema_version must be riido-policy-bundle-loader-evidence.v1"})
	}
