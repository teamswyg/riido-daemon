...
func renderRoot(m manifest) string {
	return renderDoc(m.Title, "", func(b *strings.Builder) {
		b.WriteString("[Back to provider runtime](../provider-runtime.md)\n\n")
		fmt.Fprintf(b, "Executable SSOT: [`runtime-responsibility.riido.json`](runtime-responsibility.riido.json).\n\n")
