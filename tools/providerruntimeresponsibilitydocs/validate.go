...
const (
	manifestSchema = "riido-provider-runtime-responsibility-docs.v1"
	detailSchema   = "riido-provider-runtime-responsibility-detail.v1"
)
...
func validateManifest(repo string, m manifest) ([]string, []sourceCheckResult) {
	...
	if len(m.DetailPages) != 8 || len(m.Details) != 8 {
		problems = append(problems, "eight generated detail pages are required")
	}
