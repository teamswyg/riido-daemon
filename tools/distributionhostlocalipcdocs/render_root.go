...
func renderRoot(m manifest) string {
	return renderDoc(m.Title, "", func(b *strings.Builder) {
		b.WriteString("[Back to distribution host integration](../distribution-host-integration.md)\n\n")
		fmt.Fprintf(b, "Executable SSOT: [`local-ipc.riido.json`](local-ipc.riido.json).\n\n")
