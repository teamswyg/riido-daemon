...
func run(_ context.Context, opts options) error {
	...
	problems, levels, timeouts, consumers := validate(opts.Repo, manifest)
	...
	if opts.EvidenceOut != "" {
		evidence := buildEvidence(manifest, problems, levels, timeouts, consumers)
	...
	fmt.Println("shutdown-authority: clean")
	return nil
}
