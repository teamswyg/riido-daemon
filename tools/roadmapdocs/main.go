...
func main() {
	...
	flag.StringVar(&opts.Manifest, "manifest", defaultManifest, "roadmap manifest")
	flag.BoolVar(&opts.WriteDoc, "write-doc", false, "write generated doc")
	...
	fmt.Println("roadmap-docs: clean")
}
