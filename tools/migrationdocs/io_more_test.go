...
func TestMaybeWriteAndCheckDocsBranches(t *testing.T) {
	...
	assertMigrationProblem(t, checkDocs(options{Repo: dir, CheckDoc: true}, docs), "docs/out.md")
...
func assertMigrationProblem(t *testing.T, problems []string, needle string) {
	t.Helper()
