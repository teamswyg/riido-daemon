...
func run(_ context.Context, opts options) error {
	...
	problems, mappings, coverage, defaults := validate(opts.Repo, manifest)
	...
	if opts.EvidenceOut != "" {
		evidence := buildEvidence(manifest, problems, mappings, coverage, defaults)
	...
	fmt.Println("terminal-result-mapping: clean")
	return nil
}
